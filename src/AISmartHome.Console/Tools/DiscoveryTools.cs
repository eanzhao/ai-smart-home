...
public class DiscoveryTools
{
    ...
    public DiscoveryTools(EntityRegistry entityRegistry, ServiceRegistry serviceRegistry)
    {
    ...
    {
        var stats = await _entityRegistry.GetDomainStatsAsync();
        ...
        string? domain = null)
    {
        ...
        var entity = await _entityRegistry.FindBestMatchAsync(description, domain);
    ...
    {
        var domainStats = await _entityRegistry.GetDomainStatsAsync();
